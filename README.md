...
# Web UI for monitoring & administering [Asynq](https://github.com/suryatresna/asynq) task queue

## Overview

Asynqmon is a web UI tool for monitoring and administering [Asynq](https://github.com/suryatresna/asynq) queues and tasks.
...
You can download the release binary for your system from the [releases page](https://github.com/suryatresna/asynqmon/releases).
...
| `---redis-url`(string)            | `REDIS_URL`               | URL to redis or sentinel server. See [godoc](https://pkg.go.dev/github.com/suryatresna/asynq#ParseRedisURI) for supported format | ""               |
...
[![GoDoc](https://godoc.org/github.com/suryatresna/asynqmon?status.svg)](https://godoc.org/github.com/suryatresna/asynqmon)
